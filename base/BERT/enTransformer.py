...
from .Attention.Multi_Head import MultiHeadedAttention, EMSA
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, hidden, attn_heads, feed_forward_hidden, dropout):
        ...
        super().__init__()
        self.attention  = EMSA(d_model=hidden, d_k=16, d_v=16, h=attn_heads, H=10, W=20, ratio=2, apply_transform=False)
