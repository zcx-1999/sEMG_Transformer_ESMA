...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
        ...
        self.fc = nn.Sequential(nn.Linear(10 * 12 * 200, 10), )
        self.withcbam = withCBAM
        self.SE = SEBlock(self.hidden_dim[0], 6).cuda() if self.withcbam else NoSEBlock(self.hidden_dim[0], 6)
        cell_list = []

        self.fc2 = nn.Linear(10 * 200, 10)
